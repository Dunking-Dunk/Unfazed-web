    ...
    return (
        <div className="w-full h-full lg:px-16 px-4 lg:py-28 py-12 relative" ref={containerRef}>
            ...
            <div className='mt-12 flex flex-col'>
                <div className='flex lg:flex-row flex-col justify-between lg:p-24 py-4 gap-4 lg:border-b-2 border-b-0 border-[rgba(255,255,255,0.7)]'>
